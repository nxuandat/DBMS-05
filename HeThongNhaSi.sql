...
----Xoa rang buoc
-- Xóa ràng buộc khóa ngoại trên bảng HOADON
ALTER TABLE HOADON DROP CONSTRAINT FK_HOADON_HOSOBENH;
ALTER TABLE HOADON DROP CONSTRAINT FK_HOADON_NHANVIEN;
ALTER TABLE HOADON DROP CONSTRAINT FK_HOADON_LOAIDICHVU;

-- Xóa ràng buộc khóa ngoại trên bảng CHITIETTHUOC
ALTER TABLE CHITIETTHUOC DROP CONSTRAINT FK_CHITIETTHUOC_HOSOBENH;
ALTER TABLE CHITIETTHUOC DROP CONSTRAINT FK_CHITIETTHUOC_LOAITHUOC;

-- Xóa ràng buộc khóa ngoại trên bảng LICHNHASI
ALTER TABLE LICHNHASI DROP CONSTRAINT FK_LICHNHASI_NHASI;

-- Xóa ràng buộc khóa ngoại trên bảng HOSOBENH
ALTER TABLE HOSOBENH DROP CONSTRAINT FK_HOSOBENH_KHACHHANG;
ALTER TABLE HOSOBENH DROP CONSTRAINT FK_HOSOBENH_NHASI;

-- Xóa ràng buộc khóa ngoại trên bảng LICHHEN
ALTER TABLE LICHHEN DROP CONSTRAINT FK_LICHHEN_LOAIDICHVU;
ALTER TABLE LICHHEN DROP CONSTRAINT FK_LICHHEN_KHACHHANG;

-- Xóa ràng buộc khóa ngoại trên bảng CHITIETDV
ALTER TABLE CHITIETDV DROP CONSTRAINT FK_CHITIETDV_LOAIDICHVU;
ALTER TABLE CHITIETDV DROP CONSTRAINT FK_CHITIETDV_HOSOBENH;

-- Xóa ràng buộc khóa ngoại trên bảng THONGBAO
ALTER TABLE THONGBAO DROP CONSTRAINT FK_THONGBAO_KHACHHANG;
